...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس دحوم يرجى كلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
{
{text = '𝐒𝐨𝐮𝐫𝐬𝐞 𝐊𝐬𝐚', url="t.me/SllllS3"},
},
}
...
{
{text = '• ❼ •', callback_data="/help8"..data.sender_user_id_},
},
{
...
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"عيب عليك مين علمك؟")
elseif Text== "فواز حبيب وقلب دحوم🥺♥️" then return sendMsg(msg.chat_id_,msg.id_,"[حبيب دحوم🥺.](t.me/lFIF1")
elseif Text== "دحوم حبيب وقلب فواز🥺♥️" then return sendMsg(msg.chat_id_,msg.id_,"[حبيب فواز🥺.](t.me/GIGlG5")
elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_,"دومك بخير حياتي 😘")
elseif Text== "صاكه"  then return sendMsg(msg.chat_id_,msg.id_,"انا بعد احبك🥺♥️")
...
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"شعور متبادل")
elseif Text== "احبك"  then return sendMsg(msg.chat_id_,msg.id_,"يلبيهه اكثرر🥺🥺")
elseif Text== "😹😹😹"  then return sendMsg(msg.chat_id_,msg.id_,"ذي ضحكه بالله؟")
...
elseif Text== "احبك" then 
return sendMsg(msg.chat_id_,msg.id_,"اكثرر يابعدي♥️")
